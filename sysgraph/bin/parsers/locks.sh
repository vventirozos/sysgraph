...
if 	[ $3 = "access_share" ]
    then
    cat $2/AllLocks.csv | grep 'AccessShareLock' | awk {'print $1","$2'} > $2/output.csv
    rm $2/AllLocks.csv
    sed -i '1s/^/date,accessShareLock\n&/' $2/output.csv
elif	[ $3 = "row_exclusive" ]
    then
    cat $2/AllLocks.csv | grep 'RowExclusiveLock' | awk {'print $1","$2'} > $2/output.csv
    rm $2/AllLocks.csv
    sed -i '1s/^/date,rowExclusiveLock\n&/' $2/output.csv
elif	[ $3 = "share_lock" ]
    then
    cat $2/AllLocks.csv | grep 'ShareLock' | grep -v 'AccessShareLock' | awk {'print $1","$2'} > $2/output.csv
    rm $2/AllLocks.csv
    sed -i '1s/^/date,shareLock\n&/' $2/output.csv
elif	[ $3 = "exclusive_lock" ]
    then
    cat $2/AllLocks.csv | grep 'ExclusiveLock' | grep -v 'RowExclusiveLock' | awk {'print $1","$2'} > $2/output.csv
    ...
    join -a1 -a2 -1 1 -2 1 -o 0 1.2 2.2 -e "0" $2/AccessShareLock.csv $2/ShareLock.csv | awk {'print $1","$2","$3'} > $2/output.csv
    rm $2/AllLocks.csv
    rm $2/ShareLock.csv
...
sed -i '1s/^/date,rowExclusiveLock,exclusiveLock\n&/' $2/output.csv
    ...
    join -a1 -a2 -1 1 -2 1 -o 0 1.2 2.2 -e "0" $2/ASLTemp.csv $2/SLTemp.csv | awk {'print $1","$2","$3'} > $2/output.csv
    rm $2/SLTemp.csv
    rm $2/ASLTemp.csv
    rm $2/ELTemp.csv
    rm $2/RELTemp.csv
